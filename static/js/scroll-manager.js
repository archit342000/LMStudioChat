    ...
    if (_isIOS) {
      ...
      document.addEventListener("touchmove", (e) => {
        const scrollTarget = e.target.closest(
          "#messages, #workspace-view, .modal-body, .cm-scroller, #file-system-preview-container, .file-system-body, .thought-modal-body, .sidebar-content, .thought-container.expanded .thought-body-inner"
        );
        if (!scrollTarget) {
          e.preventDefault();
        }
